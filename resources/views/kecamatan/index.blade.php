                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table table align-items-center mb-0" data-type="kecamatan" id="dataTable">
                                <thead>
                                    <tr>
                                        <th style="width: 200px;" class="text-dark text-center text-sm font-weight-medium">No
                                        </th>
