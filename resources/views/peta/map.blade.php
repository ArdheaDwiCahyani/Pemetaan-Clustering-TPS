...
@section('content')
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-body">
                <!-- Form Dropdown dan Tombol Tampilkan -->
                <form id="yearForm">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <button type="button" id="showMapBtn" class="btn btn-primary">Tampilkan</button>
                        </div>
                    </div>
                </form>
                <!-- Peta Section -->
                <div id="map" style="height: 370px; position: relative;">
                    <!-- Legend Section -->
...
@section('scripts')
    ...
    <script>
        ...
        // Menangani klik tombol Tampilkan
        document.getElementById('showMapBtn').addEventListener('click', function() {
            const selectedYear = document.getElementById('yearSelect').value;

            if (selectedYear) {
                // Ambil data GeoJSON berdasarkan tahun yang dipilih
                const geojsonClusterUrl = `/peta/geojson/${selectedYear}`;
                ...
                fetch(geojsonClusterUrl)
                    ...
                    .then(data => {
                        ...
                        // Menambahkan marker berbentuk circleMarker berdasarkan data clustering
