        ...
        {{-- <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">@yield('title')
                    <a class="{{ request()->routeIs() }} opacity-5 text-white" href=""></a>
                </li>
                @if (request()->routeIs('kecamatan.tambah') || request()->routeIs('kecamatan.edit'))
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ Request::routeIs('cstock') ? 'Create Data Stock' : 'Update Data Stock' }}</li>
                </ol>
            </nav>
        </div> --}}
