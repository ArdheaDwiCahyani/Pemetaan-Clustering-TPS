    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-0">
                    <div class="card-body">
                        <a href="{{ route('user.tambah') }}" class="btn btn-outline-primary mb-4 mr-2"> Tambah Data </a>
                ...
                const table = $('#data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: "role",
                            title: 'Role',
                            className: 'text-left text-dark text-sm w-10'
                        },
                        {
                            title: "Action",
                            ...
                            render: function(data, type, row) {
                                ...
                                <div class="text-center align-middle px-0" style="font-size: 20px;">
                                    ...
                                    <a href="{{ route('user.hapus', ':id') }}" id="delete">
